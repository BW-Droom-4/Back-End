...
const getUserExperienceById = async id => (
    await db('userexperiences')
    .where('id', id)
)[0]
...
const updateUserExperience = async (id, userexperience) => (
    await db('userexperiences')
    .where('id', id)
...
const updateUserInterest = async (id, userinterest) => (
    await db('userinterests')
    .where('id', id)
    .update(userinterest)
)[0]
